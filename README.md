...
- 玩家帳號同時作為遊戲內公開名稱
- 地圖式五大能力訓練館
- 每座場館依 CEFR 程度每日安排 10 題國小英語練習
- 題組依台北日期與學生帳號每日更新，同日保持一致
- A1 以上混合本級新題與基礎複習題，Pre-A1 維持基礎範圍
- 三組每日推薦任務分別訓練閱讀、聽力與拼字
- 同一場館或推薦任務當日第一次提供完整 XP，第二次起 XP 折半
- 世界航圖包含十個主題國家，每國提供 10 個圖像單字與聽、說、讀、寫關卡
- 主題國家單字支援點擊發音，每座關卡完成後可獲得 XP
- XP 與答題學習事件
- 玩家「我的能力」依個人實際五項進度及本週學習事件呈現
- 完成訓練後即時更新能力雷達圖、能力值與個人化分析
- 管理員查看所有學生、教師、待審核申請及班級配對
- 管理員可核准教師帳號，並查看各班教師、學生及五大能力
- 管理員帳號頁可依全部、教師、學生篩選
- 管理員可補登教師信箱，並修改姓名、學校、班級、座號、程度與核准狀態
- 教師信箱修改會同步更新登入及忘記密碼收件信箱
- 密碼僅顯示遮罩與最近更新時間，系統不儲存或揭露明文密碼
- 教師後台僅讀取自己班級的真實學生資料
- 教師查看全班與個別學習狀況、關注學生、易錯題型及單字
- 新教師註冊需填信箱，並可由登入頁寄送安全密碼重設連結
- 每題作答紀錄用於班級錯題分析
- 教師任務資料結構
